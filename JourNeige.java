            ...
            try {
                ...
                while (scanner.hasNextLine()) {
                    ...
                    if (line.contains(villeString)) {
                        ...
                        String villeScan = parts[0].split(": ")[1]; // Prend la ville dans le Donnees.txt
                        ...
                        } //if loop pour check le ville entrez est dans le fichier données, et setText si oui
                ...
                JOptionPane.showMessageDialog(this, "Le fichier de donées n'as pas été trouvé.");
            } finally {
                if (scanner != null) {
                    scanner.close();
                } 
